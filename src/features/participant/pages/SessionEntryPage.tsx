      ...
      >
          ...
          <div className="w-full max-w-4xl bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-5 my-auto">
            ...
            <div className="md:col-span-2 p-6 flex flex-col justify-between space-y-6">
              <div className="space-y-2">
                ...
                <div className="bg-emerald-500/10 border border-emerald-500/25 rounded-xl p-3 text-left flex items-start gap-2.5 shadow-sm">
                  <CheckCircle className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                  <p className="text-xs text-emerald-200/90 leading-relaxed font-medium">
                    <strong>Admission Confirmed:</strong> You are confirmed! Please stay on this page and wait for the interviewer to start the session.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  {isSessionStarted === null ? (
                    ...
                    <>
                      <Spinner className="w-4 h-4 border-t-2 border-b-2 border-amber-400" />
        ...
        {pageState === "finalized" && (
          <div className="w-full max-w-lg bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl p-8 text-center my-auto space-y-6">
            ...
            <div className="bg-blue-500/10 border border-blue-500/25 rounded-xl p-4 text-left flex items-start gap-3 shadow-sm">
              <ShieldCheck className="w-5 h-5 text-blue-400 shrink-0 mt-0.5" />
              <p className="text-xs text-blue-200/90 leading-relaxed font-medium">
                <strong>Interview Complete:</strong> Thank you for participating! The interviewer will follow up with you directly regarding next steps. You can safely close your window now.
              </p>
            </div>
            <div className="pt-2">
              {slug === "interview" ? (
