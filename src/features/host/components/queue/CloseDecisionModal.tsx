            ...
            >
                ...
                <div className="flex items-start justify-between gap-3 px-4 sm:px-6 pt-3 sm:pt-6 pb-2 sm:pb-4 shrink-0 border-b border-slate-50 sm:border-none">
                    <div className="min-w-0 flex-1">
                        <h2 className="text-base sm:text-xl font-bold text-gray-900 tracking-tight">
                            {isCloseEarly ? "Close Window Early?" : "Window Ended"}
                        </h2>
                        <p className="text-xs sm:text-sm text-gray-500 font-medium mt-0.5">
                            {isCloseEarly ? "This will block new applicant entries." : "New applicant entries are now blocked."}
                        </p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="px-4 sm:px-6 py-2 sm:py-0 sm:pb-6 space-y-2 sm:space-y-5 overflow-y-auto flex-1 min-h-0">
                    {waitingCount > 0 ? (
                        ...
                        <div className="flex items-start gap-2.5 sm:gap-3 rounded-xl bg-slate-50 border border-slate-200/60 p-3.5 sm:p-5 my-2">
                            <ShieldCheck className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                            <div className="text-xs sm:text-sm text-slate-700 font-medium leading-relaxed">
                                There are no candidates waiting in the queue. Closing early will immediately end this window for new entries.
                            </div>
                        </div>
                    )}
                </div>
